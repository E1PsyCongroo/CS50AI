...
class CrosswordCreator():
    ...
    def revise(self, x, y):
        ...
        for xWord in set(self.domains[x]):
            ...
            for yWord in self.domains[y]:
                if xWord != yWord and (xWord[overlaps[0]] == yWord[overlaps[1]] if overlaps else True):
                    anyChoice = True
                    break
    ...
    def consistent(self, assignment):
        ...
        for x in assignment.keys():
            ...
            if assignment[x] in used_word:
                return False
            used_word.add(assignment[x])
    ...
    def order_domain_values(self, var, assignment):
        ...
        """
        neighbors_unassigned = self.crossword.neighbors(var) - set(assignment.keys())
        ...
        return sorted(self.domains[var], key=sort_key, reverse=True)
    ...
    def select_unassigned_variable(self, assignment):
        ...
        if len(unassigned) > 1:
            def sort_key(var):
                ...
                m = len(self.crossword.neighbors(var))
                return n, m

            unassigned.sort(key=sort_key, reverse=True)
        return unassigned[0]
    ...
    def backtrack(self, assignment):
        ...
        for word in self.order_domain_values(var, assignment):
            ...
            if self.consistent(assignment) and self.ac3():
